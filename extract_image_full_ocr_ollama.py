...
DEFAULT_VLLM_MODEL = "ibm-granite/granite-docling-258M"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="ollama",
        help="Remote runtime type. Default: ollama",
    )
    parser.add_argument(
        "--endpoint",
        default=None,
    ...
    parser.add_argument(
        ...
        type=int,
        default=8192,
        help="Maximum output tokens for generic/vLLM endpoints. Default: 8192",
    )
    parser.add_argument(
        "--scale",
        type=float,
    ...
    parser.add_argument(
        "--skip-health-check",
        action="store_true",
        help="Do not probe the local endpoint before conversion.",
    )
